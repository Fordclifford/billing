...
<head>
    ...
    @else
        <title>{{ isset($title) ? ($title . ' | Techsavanna Billing') : ('Techsavanna Billing | ' . trans('texts.app_title')) }}</title>
...
<!-- Version: {{ NINJA_VERSION }} -->
    ...
    <meta charset="utf-8">
    <meta property="og:site_name" content="Techsavanna Billing"/>
    <meta property="og:url" content="{{ SITE_URL }}"/>
    <meta property="og:title" content="Techsavanna Billing"/>
    ...
    <meta name="apple-mobile-web-app-title" content="Techsavanna Billing">
    <meta name="application-name" content="Techsavanna Billing">
